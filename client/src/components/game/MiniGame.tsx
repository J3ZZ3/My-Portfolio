...
export function MiniGame() {
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.code === "Space") {
        ...
        if (isPlaying) {
          ...
          setIsPlaying(true);
          resetGame(); // Reset variables for new run logic if needed, but here mostly handled in draw init or separate reset
        } else if (gameOver) {
           setIsPlaying(true);
           resetGame();
           draw(); // Restart loop
  ...
  return (
    <div className="h-full w-full p-6 flex flex-col items-center justify-center font-hud">
